...
> 原文:[https://www.javatpoint.com/mysql-delete](https://www.javatpoint.com/mysql-delete)
...
![mysql delete query](../Images/58dcfb7e7478d5a65bf14ea47bd02ce8.png)
![mysql delete query](../Images/05ba5dee91004416e8afb551e49872c6.png)
...
![mysql delete query](../Images/d9ed344bdc163e8c4a0e4f1362d72979.png)

如果我们想删除表中的所有记录，就不需要在 delete 语句中使用 WHERE 子句。请参见下面的代码和输出:

![mysql delete query](../Images/91921baffc9c45c2557f9a5e86c416bd.png)
...
![mysql delete query](../Images/5f69a73f0f8a088730604661a6a00c21.png)
...
![mysql delete query](../Images/defe26f1b5243c36b73a25df758d274c.png)
