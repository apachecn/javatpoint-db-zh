...
> 原文:[https://www.javatpoint.com/mongodb-gte-operator](https://www.javatpoint.com/mongodb-gte-operator)

## MongoDB 中的$gte 运算符是什么？

MongoDB 提供了多种比较查询操作符。$gte(大于等于)运算符就是其中之一。$gte 运算符用于选择字段值大于或等于(即> =)给定值的文档。您可以根据需要在更新、查找等方法中使用该运算符。
...
在本例中，我们更新了具有 3 年以上工作经验的员工的薪资字段。
