...
> 原文:[https://www.javatpoint.com/types-of-sql-commands](https://www.javatpoint.com/types-of-sql-commands)

SQL 是一种结构化查询语言，用于处理结构化数据。结构化数据是通常以关系或表的形式存储的数据。

每当我们将数据存储在表或关系中时，我们都需要 SQL 命令。此外，还需要这些命令来检索存储在表中的数据。

![Types of SQL Commands](../Images/b243ba2ea4366c4536ac536d2f5541a5.png)
...
![Types of SQL Commands](../Images/5cc6734dbae2d061970b7a0b2a1dbc34.png)
...
![Types of SQL Commands](../Images/11ffb153ec7f1cea1a1b72f160344039.png)
...
![Types of SQL Commands](../Images/419135daf883b3211123e80ab62d8824.png)
...
![Types of SQL Commands](../Images/17483c342012bf3cff1cc6b66cad12df.png)
...
![Types of SQL Commands](../Images/b9b4c6b8ba428071e33417705fd5bc24.png)
...
![Types of SQL Commands](../Images/90a0d9b485688ac1cc3becdb26b2f5be.png)

```
mysql> ALTER TABLE t_school ADD Board_of_Education VARCHAR(20);
```

![Types of SQL Commands](../Images/c2072579aeea7923499d05a5c1cd79a5.png)
...
![Types of SQL Commands](../Images/a782054cf5729976ec73d3c79209c480.png)
...
![Types of SQL Commands](../Images/95a9c0e6584f0f3321d376a28151f852.png)

```
mysql> ALTER TABLE t_school DROP COLUMN Board_of_Education;
```

![Types of SQL Commands](../Images/328cb4277482b086a4e9aaff38d01897.png)
...
![Types of SQL Commands](../Images/4f9f89a081f03e3cefe4bf01a727ae8e.png)
...
![Types of SQL Commands](../Images/67c022495c8186f10142e74e57bbe2a1.png)
...
![Types of SQL Commands](../Images/50a2ccdb88d801469f439d6fd6f93fc9.png)

```
mysql> ALTER TABLE t_school MODIFY ID VARCHAR(20);
```

![Types of SQL Commands](../Images/c6e62df4d3653ec8c6288d4608165fe4.png)
...
![Types of SQL Commands](../Images/31e97459f48a957e18e7b7fd638fd431.png)
...
![Types of SQL Commands](../Images/fc8b54215e015e0734abe3305f8f1475.png)
...
![Types of SQL Commands](../Images/8059c9d3eed7b2b74a815144fac30d94.png)
...
![Types of SQL Commands](../Images/66dd8525c54eb66b82c18d43a71433e9.png)
...
![Types of SQL Commands](../Images/2e38e5567751f974ebd9930ba2fa0fba.png)
...
![Types of SQL Commands](../Images/a5159d6b88eaf4ca6221e4f1e1082fa4.png)

```
mysql> RENAME TABLE t_school TO tbl_school;
```

![Types of SQL Commands](../Images/bb62f9dbbbf2a79e02092db1f1508f0a.png)
...
![Types of SQL Commands](../Images/f3561760d552243fcdd173b97b539062.png)
...
![Types of SQL Commands](../Images/ef6664dd02e9620855955afcfed9f473.png)
...
![Types of SQL Commands](../Images/e8b1a9fa10c90c2b0a9dd4fc98c4ea6b.png)
...
![Types of SQL Commands](../Images/b822435a9489e82bbfbc473c7ea4863f.png)
...
![Types of SQL Commands](../Images/062d206f6a91bc9ec4664894f6d98ea8.png)

```
mysql>INSERT INTO t_school(ID, School_Name, Number_of_Students, Number_of_Teachers, Number_of_Classrooms, EmailID) VALUES(1, "Boys Town Public School", 1000, 80, 12, "btps15@gmail.com"), (2, "Guru Govind Singh Public School", 800, 35, 15, "ggps25@gmail.com"), (3, "Delhi Public School", 1200, 30, 10, "dps101@gmail.com"), (4, "Ashoka Universal School", 1110, 40, 40, "aus17@gmail.com"), (5, "Calibers English Medium School", 9000, 31, 50, "cems@gmail.com");
```

![Types of SQL Commands](../Images/a5c636d2bcb38e9ef3e6759d7e666630.png)

```
mysql> COMMIT;
```

![Types of SQL Commands](../Images/64e1a5a4a1839ab3734ba1963bf1a431.png)

```
mysql> SET autocommit = 0;
```

![Types of SQL Commands](../Images/5341ed155be20d163dac1f47003ff5f2.png)

```
mysql> SAVEPOINT ins;
```

![Types of SQL Commands](../Images/c17e4a7b8288f400529da2d3f620356b.png)
...
![Types of SQL Commands](../Images/7b608579fffb849ffad9e29ea29e6b34.png)

```
mysql> SAVEPOINT del;
```

![Types of SQL Commands](../Images/4bb811558b1686e8006fa85e952ce21b.png)
...
![Types of SQL Commands](../Images/8f9d0adf57a4ba17289ee51a7ad401cd.png)
